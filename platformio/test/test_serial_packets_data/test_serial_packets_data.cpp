...
void test_constructor() {
  ...
  TEST_ASSERT_EQUAL(0, d1.bytes_left_to_read());
  TEST_ASSERT_TRUE(d1.all_read());
  TEST_ASSERT_FALSE(d1.read_errors());
  TEST_ASSERT_FALSE(d1.write_errors());
...
void test_write_uint8() {
  ...
  TEST_ASSERT_EQUAL(0, d1.bytes_read());
  TEST_ASSERT_EQUAL(1, d1.bytes_left_to_read());
...
void test_write_uint8_new_error() {
  ...
  d1.write_uint8(0x02);
  TEST_ASSERT_TRUE(d1.write_errors());
...
void test_write_uint16() {
  ...
  TEST_ASSERT_EQUAL(0, d1.bytes_read());
  TEST_ASSERT_EQUAL(4, d1.bytes_left_to_read());
  assert_data_equals(d1, {0x11, 0x22, 0x33, 0x44});
}
...
void test_write_uint32() {
  ...
  TEST_ASSERT_EQUAL(0, d1.bytes_read());
  TEST_ASSERT_EQUAL(6, d1.bytes_left_to_read());
...
void test_write_bytes() {
  ...
  TEST_ASSERT_EQUAL(0, d1.bytes_read());
  TEST_ASSERT_EQUAL(5, d1.bytes_left_to_read());
...
void test_read_uint8_new_error() {
  ...
  // const uint8_t v2 = d1.read_uint8();
  TEST_ASSERT_TRUE(d1.read_errors());
...
void test_read_uint32_new_error() {
  ...
  TEST_ASSERT_EQUAL(0, d1.bytes_read());
  TEST_ASSERT_EQUAL(3, d1.bytes_left_to_read());
}
...
void test_read_bytes_new_error() {
  ...
  TEST_ASSERT_EQUAL(0, d1.bytes_read());
  TEST_ASSERT_EQUAL(2, d1.bytes_left_to_read());
}
...
void test_read_data_new_src_error() {
  ...
  TEST_ASSERT_EQUAL(0, d1.bytes_read());
  TEST_ASSERT_EQUAL(4, d1.bytes_left_to_read());
  TEST_ASSERT_FALSE(d2.read_errors());
  TEST_ASSERT_FALSE(d2.write_errors());
